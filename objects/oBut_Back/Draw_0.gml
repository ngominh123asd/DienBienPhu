/// @description Premium Tactical Draw (Red Warning)
...
draw_set_color(merge_color(make_color_rgb(85, 100, 90), make_color_rgb(240, 80, 80), hover_val));
...
var text_color = merge_color(make_color_rgb(205, 215, 210), make_color_rgb(255, 110, 110), hover_val);
